...
def parser():
   #This creates the parser
    ...
    parser.add_argument('--model', choices=['lenet5'], default='lenet5', #This adds an argument to the parser
    ...
    parser.add_argument('--alpha', type=float, default=0.2, help="Dirichelet concentration parameter")
    parser.add_argument('--th_coeff', type=float, default = 0.002, help = "regularizer for thresholds")
    parser.add_argument('--th_update', type=int, default = 1, help = "parameter importance update")
    parser.add_argument('--weight_decay', type=float, default=0., help="SGD weight decay(defalt: 0.)")
    parser.add_argument('--local_epoch', type=int, default = 3, help = "number of local iterations (default = 5)")
